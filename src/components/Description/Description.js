    ...
    return (
        <div className="main-description " >
            ...
            <div className="paragraph-box " >
                <div className="paragraph-box__text-title" ><b>LOREM IPSUM DOLOR SIT AMEN CONSECTETUR ADIPISICING ELIT?</b></div>
                <div className="paragraph-box__text-content" >Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis fugit ut itaque commodi, esse est dignissimos aperiam voluptatum repellendus, consequatur optio, voluptatem sit dolores molestias cum officia et. Eius, animi laudantium. Consequuntur cumque, error saepe quis nostrum excepturi praesentium nisi maxime quidem natus unde, quibusdam minus debitis expedita magnam perferendis dolore vel, qui tempore. Dolore eum ea ipsa praesentium nemo, eaque repellendus saepe. Atque, aliquam libero quam perferendis autem accusantium ea quae quidem nam explicabo in, amet eligendi, quaerat non!</div>
            </div>
